...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, efficient=False):
        ...
        self.bn1 = nn.BatchNorm3d(num_features=num_input_features)
        ...
        self.bn2 = nn.BatchNorm3d(num_features=bn_size * growth_rate)
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.norm = nn.BatchNorm3d(num_features=num_input_features)
...
class Densenet36(nn.Module):
    ...
    def __init__(self, in_channels=1, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.norm0 =  nn.BatchNorm3d(num_features = num_init_features)
        self.relu0 = nn.LeakyReLU(negative_slope=0.1, inplace=True)
        self.features_block1 = nn.Sequential(OrderedDict([]))
        # Each denseblock
        ...
        # G stream
        self.classifier = nn.Linear(num_features*64, num_classes)
        ...
        # self.pool6 = pool6
        self.cls_P = nn.Linear(k1 * num_classes*64, num_classes)
        # Side-branch
        self.cross_channel_pool = nn.AvgPool1d(kernel_size=k1, stride=k1, padding=0)
        self.cls_s =nn.Linear(128, num_classes)
        ...
        # self.pool6 = pool6
        self.cls_P_b2 = nn.Linear(k2 * num_classes*64, num_classes)
        # Side-branch
    ...
    def forward(self, x):
        ...
        #print(out_side.shape)
        out_side = self.cls_s(out_side.view(x.size(0), -1))
        ...
        out_side_b2 = self.cls_s(out_side_b2.view(x.size(0), -1))
