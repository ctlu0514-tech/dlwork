...
class MobileNet(nn.Module):
    def __init__(self, num_classes=2, inp=5,sample_size=512, width_mult=1.):
        ...
        self.features = [conv_bn(inp, input_channel, (1,2,2))]
...
#def mobilenet(input_channels=5, num_classes=2):
#   return MobileNet(inp=input_channels, num_classes=num_classes)
...
# ones = torch.rand(8, 1, 16, 256, 256)
# model = MobileNet()
