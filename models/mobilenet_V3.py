# -*- coding: utf-8 -*-
"""
Created on Tue Feb 27 10:57:47 2024
...
class Block(nn.Module):
    ...
    def __init__(self, kernel_size, in_size, expand_size, out_size, nolinear, semodule, stride):
        ...
        self.conv2 = nn.Conv3d(expand_size, expand_size, kernel_size=kernel_size, stride=stride, padding=kernel_size//2, groups=expand_size, bias=False)
...
class MobileNetV3_Large(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.conv1 = nn.Conv3d(5, 16, kernel_size=3, stride=2, padding=1, bias=False)
...
class MobileNetV3_Small(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.hs2 = hswish()
        self.linear3 = nn.Linear(2304, 1280)
        self.bn3 = nn.BatchNorm1d(1280)
        self.hs3 = hswish()
        self.linear4 = nn.Linear(1280, num_classes)
        self.init_params()
