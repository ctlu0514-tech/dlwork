...
class ResNet(nn.Module):
    def __init__(self,
        ...
        self.cbam1 = CBAM(block_inplanes[0]*block.expansion, 16 , 7)
        self.cbam2 = CBAM(block_inplanes[1]*block.expansion, 16 , 7)
        self.cbam3 = CBAM(block_inplanes[2]*block.expansion, 16 , 7)
        self.cbam4 = CBAM(block_inplanes[3]*block.expansion, 16 , 7)
...
def resnet34(input_channels=1, num_classes=2,attention='false'):
    return ResNet(BasicBlock, [3, 4, 6, 3], get_inplanes(), n_input_channels=input_channels, n_classes=num_classes,attention=attention)



def resnet50(input_channels=1, num_classes=2,attention='false'):
    return ResNet(Bottleneck, [3, 4, 6, 3],  get_inplanes(), n_input_channels=input_channels, n_classes=num_classes,attention=attention)
