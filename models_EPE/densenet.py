...
class _DenseLayer(nn.Sequential):
    ...
    def forward(self, x):
        ...
        if self.drop_rate > 0:
            new_features = self.dropout(self.drop_rate)
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv3d(1, num_init_features, kernel_size=3, stride=1, padding=1, bias=True))]))
        ...
        self.fc = nn.Linear(num_features, 4)
