...
parser.add_argument('--devices', default='4', type=str,
...
parser.add_argument('--model', choices=['MobileNet', 'resnet10', 'resnet18', 'resnet34','resnet50','resnet101','C3D', 'CNN_3D','Att_CNN_3D','LeNet', 'AlexNet','vit'], default='resnet50')
...
def main(args):
    ...
    args.save_folder = pathlib.Path(f"/Dataset/yyp/prostate_ISUP_data/code/result/Dataset_crop_N4_hist/RandAffine"
                                    f"/{args.exp_name}")
    ...
    model = get_arch(model_name=args.model, attention=args.attention)
